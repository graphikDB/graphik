...
type SubGraphFilter struct {
	...
	EdgeFilter           *TypeFilter `protobuf:"bytes,2,opt,name=edge_filter,json=edgeFilter,proto3" json:"edge_filter,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *SubGraphFilter) GetEdgeFilter() *TypeFilter {
	if m != nil {
		return m.EdgeFilter
	}
	return nil
...
var fileDescriptor_063490d3009de3e6 = []byte{
	...
	0x11, 0xf7, 0x1f, 0x39, 0xb2, 0xdb, 0xd9, 0x44, 0x3b, 0xdc, 0x71, 0x3e, 0xdf, 0x6d, 0x25, 0x2b,
	...
	0x3d, 0x23, 0x69, 0xac, 0x38, 0x09, 0x54, 0xb1, 0xbc, 0x49, 0xdd, 0x3d, 0xbf, 0xee, 0xf9, 0xcd,
	0xf4, 0x9f, 0x81, 0xc7, 0x6e, 0x12, 0x1e, 0x06, 0xa9, 0x9b, 0xcc, 0xc2, 0x6f, 0x0e, 0x92, 0x34,
	0x16, 0x31, 0x6b, 0xba, 0x49, 0xd8, 0xff, 0x38, 0x88, 0xe3, 0x60, 0xce, 0x0f, 0x49, 0x34, 0x5d,
	0xde, 0x1c, 0x66, 0x22, 0x5d, 0x7a, 0x42, 0x9a, 0xf4, 0x77, 0xaa, 0x5a, 0x11, 0x2e, 0x78, 0x26,
	0xdc, 0x45, 0xa2, 0x0c, 0x3e, 0xac, 0x1a, 0xb8, 0xd1, 0x5b, 0xa5, 0xfa, 0xa8, 0xaa, 0xe2, 0x8b,
	0x44, 0x28, 0xa5, 0xbd, 0x03, 0xe6, 0x30, 0x5e, 0x46, 0x82, 0xa7, 0xec, 0x3d, 0x68, 0x79, 0xf8,
	...
	,
}
