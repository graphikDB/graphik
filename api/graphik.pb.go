...
func (m *EdgeChange) GetBefore() *Node {
	if m != nil {
		return m.Before
	}
	return nil
...
func (m *EdgeChange) GetAfter() *Node {
	if m != nil {
		return m.After
	}
	return nil
...
type Change_EdgeChange struct {
	EdgeChange *EdgeChange `protobuf:"bytes,4,opt,name=edge_change,json=edgeChange,proto3,oneof"`
}

type Change_NodeChange struct {
	NodeChange *NodeChange `protobuf:"bytes,5,opt,name=node_change,json=nodeChange,proto3,oneof"`
}

func (*Change_EdgeChange) isChange_Change() {}

func (*Change_NodeChange) isChange_Change() {}
...
func (m *Change) GetEdgeChange() *EdgeChange {
	if x, ok := m.GetChange().(*Change_EdgeChange); ok {
		return x.EdgeChange
	}
	return nil
}

func (m *Change) GetNodeChange() *NodeChange {
	if x, ok := m.GetChange().(*Change_NodeChange); ok {
		return x.NodeChange
	}
	return nil
}
...
func (*Change) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*Change_EdgeChange)(nil),
		(*Change_NodeChange)(nil),
	}
}
...
var fileDescriptor_063490d3009de3e6 = []byte{
	...
	,
}
