...
func (m *PatchFilter) GetPatch() *Patch {
	if m != nil {
		return m.Patch
	}
	return nil
...
type Interception struct {
	...
	Timing               Timing               `protobuf:"varint,6,opt,name=timing,proto3,enum=api.Timing" json:"timing,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
var fileDescriptor_063490d3009de3e6 = []byte{
	...
	,
}
