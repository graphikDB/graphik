...
func (ec *executionContext) field_Query_depthSearch_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNDepthFilter2githubᚗcomᚋautom8terᚋgraphikᚋgraphᚋmodelᚐDepthFilter(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Command_op(ctx context.Context, field graphql.CollectedField, obj *model.Command) (ret graphql.Marshaler) {
	...
	res := resTmp.(model.Op)
	fc.Result = res
	return ec.marshalNOp2githubᚗcomᚋautom8terᚋgraphikᚋgraphᚋmodelᚐOp(ctx, field.Selections, res)
}
