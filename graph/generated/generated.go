...
func (ec *executionContext) field_Mutation_createNode_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewNode2githubᚗcomᚋautom8terᚋgraphikᚋgraphᚋmodelᚐNewNode(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalInputQueryNodes(ctx context.Context, obj interface{}) (model.QueryNodes, error) {
	...
	for k, v := range asMap {
		...
		case "filters":
			...
			it.Filters, err = ec.unmarshalOFilter2ᚕᚖgithubᚗcomᚋautom8terᚋgraphikᚋgraphᚋmodelᚐFilter(ctx, v)
			if err != nil {
				return it, err
			}
		case "limit":
...
func (ec *executionContext) unmarshalNNewNode2githubᚗcomᚋautom8terᚋgraphikᚋgraphᚋmodelᚐNewNode(ctx context.Context, v interface{}) (model.NewNode, error) {
...
func (ec *executionContext) unmarshalOFilter2ᚕᚖgithubᚗcomᚋautom8terᚋgraphikᚋgraphᚋmodelᚐFilter(ctx context.Context, v interface{}) ([]*model.Filter, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []interface{}
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalOFilter2ᚖgithubᚗcomᚋautom8terᚋgraphikᚋgraphᚋmodelᚐFilter(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalOFilter2ᚖgithubᚗcomᚋautom8terᚋgraphikᚋgraphᚋmodelᚐFilter(ctx context.Context, v interface{}) (*model.Filter, error) {
	if v == nil {
		return nil, nil
	}
