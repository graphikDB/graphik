...
func (e EdgeFunc) ascendFrom(g *Graph,  visited map[string]struct{}) EdgeFunc {
	return func(edge *apipb.Edge) bool {
		if _, ok := visited[edge.GetPath().String()]; ok {
			return true
		}
		visited[edge.GetPath().String()] = struct{}{}
...
func (e EdgeFunc) ascendTo(g *Graph, visited map[string]struct{}) EdgeFunc {
	return func(edge *apipb.Edge) bool {
		if _, ok := visited[edge.GetPath().String()]; ok {
			return true
		}
