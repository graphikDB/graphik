...
proto.api.Traversal.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    relativeRef: (f = msg.getRelativeRef()) && proto.api.Refs.toObject(includeInstance, f),
...
proto.api.Traversal.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.api.Refs;
      reader.readMessage(value,proto.api.Refs.deserializeBinaryFromReader);
      msg.setRelativeRef(value);
      break;
    case 3:
...
proto.api.Traversal.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getRelativeRef();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.api.Refs.serializeBinaryToWriter
    );
  }
...
/**
 * optional Refs relative_ref = 2;
 * @return {?proto.api.Refs}
 */
proto.api.Traversal.prototype.getRelativeRef = function() {
  return /** @type{?proto.api.Refs} */ (
    jspb.Message.getWrapperField(this, proto.api.Refs, 2));
};


/** @param {?proto.api.Refs|undefined} value */
proto.api.Traversal.prototype.setRelativeRef = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.api.Traversal.prototype.clearRelativeRef = function() {
  this.setRelativeRef(undefined);
};
 ...
 * @return {!boolean}
 */
proto.api.Traversal.prototype.hasRelativeRef = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {?proto.api.Ref}
 */
proto.api.CFilter.prototype.getDocRef = function() {
  return /** @type{?proto.api.Ref} */ (
    jspb.Message.getWrapperField(this, proto.api.Ref, 1));
};
...
/** @param {?proto.api.Ref|undefined} value */
proto.api.CFilter.prototype.setDocRef = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.api.CFilter.prototype.clearDocRef = function() {
 ...
 * @return {!boolean}
 */
proto.api.CFilter.prototype.hasDocRef = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.api.Message.toObject = function(includeInstance, msg) {
  var f, obj = {
    channel: jspb.Message.getFieldWithDefault(msg, 1, ""),
    data: (f = msg.getData()) && google_protobuf_struct_pb.Struct.toObject(includeInstance, f),
    sender: (f = msg.getSender()) && proto.api.Ref.toObject(includeInstance, f),
