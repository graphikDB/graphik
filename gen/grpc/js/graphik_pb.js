...
goog.exportSymbol('proto.api.Constraint', null, global);
goog.exportSymbol('proto.api.Constraints', null, global);
...
goog.exportSymbol('proto.api.UIFlags', null, global);
 ...
 * @constructor
 */
proto.api.Constraint = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.Constraint, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.api.Constraint.displayName = 'proto.api.Constraint';
}
 ...
 * @return {!Object}
 */
proto.api.Constraint.prototype.toObject = function(opt_includeInstance) {
  return proto.api.Constraint.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.Constraint} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.Constraint.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    gtype: jspb.Message.getFieldWithDefault(msg, 2, ""),
    expression: jspb.Message.getFieldWithDefault(msg, 3, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.Constraint}
 */
proto.api.Constraint.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.Constraint;
  return proto.api.Constraint.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.Constraint} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.Constraint}
 */
proto.api.Constraint.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.Constraint.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.Constraint.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.Constraint} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.Constraint.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api.Constraint.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.api.Constraint.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.api.Constraint.prototype.getGtype = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.api.Constraint.prototype.setGtype = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.api.Constraint.prototype.getExpression = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.api.Constraint.prototype.setExpression = function(value) {
  jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {boolean}
 */
proto.api.Constraint.prototype.getTargetDocs = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 4, false));
};


/** @param {boolean} value */
proto.api.Constraint.prototype.setTargetDocs = function(value) {
  jspb.Message.setProto3BooleanField(this, 4, value);
};
 ...
 * @return {boolean}
 */
proto.api.Constraint.prototype.getTargetConnections = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 5, false));
};


/** @param {boolean} value */
proto.api.Constraint.prototype.setTargetConnections = function(value) {
  jspb.Message.setProto3BooleanField(this, 5, value);
};
 ...
 * @constructor
 */
proto.api.Constraints = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.Constraints.repeatedFields_, null);
};
goog.inherits(proto.api.Constraints, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.api.Constraints.displayName = 'proto.api.Constraints';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.api.Constraints.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.api.Constraints.prototype.toObject = function(opt_includeInstance) {
  return proto.api.Constraints.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.Constraints} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.Constraints.toObject = function(includeInstance, msg) {
  var f, obj = {
    constraintsList: jspb.Message.toObjectList(msg.getConstraintsList(),
    proto.api.Constraint.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.Constraints}
 */
proto.api.Constraints.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.Constraints;
  return proto.api.Constraints.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.Constraints} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.Constraints}
 */
proto.api.Constraints.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.api.Constraint;
      reader.readMessage(value,proto.api.Constraint.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.api.Constraints.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.Constraints.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.Constraints} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.Constraints.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.api.Constraint.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.api.Constraint>}
 */
proto.api.Constraints.prototype.getConstraintsList = function() {
  return /** @type{!Array<!proto.api.Constraint>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api.Constraint, 1));
};


/** @param {!Array<!proto.api.Constraint>} value */
proto.api.Constraints.prototype.setConstraintsList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.api.Constraint=} opt_value
 * @param {number=} opt_index
 * @return {!proto.api.Constraint}
 */
proto.api.Constraints.prototype.addConstraints = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.api.Constraint, opt_index);
};


proto.api.Constraints.prototype.clearConstraintsList = function() {
...
proto.api.Flags.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    enableUi: jspb.Message.getFieldWithDefault(msg, 27, false)
  };
...
/**
 * optional bool enable_ui = 27;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.api.Flags.prototype.getEnableUi = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 27, false));
};


/** @param {boolean} value */
proto.api.Flags.prototype.setEnableUi = function(value) {
 ...
 * @constructor
 */
proto.api.UIFlags = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.UIFlags.repeatedFields_, null);
};
goog.inherits(proto.api.UIFlags, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.api.UIFlags.displayName = 'proto.api.UIFlags';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.api.UIFlags.repeatedFields_ = [6];
 ...
 * @return {!Object}
 */
proto.api.UIFlags.prototype.toObject = function(opt_includeInstance) {
  return proto.api.UIFlags.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.UIFlags} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.UIFlags.toObject = function(includeInstance, msg) {
  var f, obj = {
    oauthClientId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    oauthClientSecret: jspb.Message.getFieldWithDefault(msg, 2, ""),
    oauthAuthorizationUrl: jspb.Message.getFieldWithDefault(msg, 3, ""),
    oauthTokenUrl: jspb.Message.getFieldWithDefault(msg, 4, ""),
    oauthRedirectUrl: jspb.Message.getFieldWithDefault(msg, 5, ""),
    oauthScopesList: jspb.Message.getRepeatedField(msg, 6),
    sessionSecret: jspb.Message.getFieldWithDefault(msg, 7, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.UIFlags}
 */
proto.api.UIFlags.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.UIFlags;
  return proto.api.UIFlags.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.UIFlags} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.UIFlags}
 */
proto.api.UIFlags.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 3:
      var value = /** @type {string} */ (reader.readString());
      msg.setOauthAuthorizationUrl(value);
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
      msg.setOauthTokenUrl(value);
      break;
    case 5:
      var value = /** @type {string} */ (reader.readString());
      msg.setOauthRedirectUrl(value);
      break;
    case 6:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @return {!Uint8Array}
 */
proto.api.UIFlags.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.UIFlags.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.UIFlags} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.UIFlags.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getOauthClientId();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
  ...
  f = message.getOauthClientSecret();
  if (f.length > 0) {
    writer.writeString(
      2,
      f
  ...
  f = message.getOauthAuthorizationUrl();
  if (f.length > 0) {
    writer.writeString(
      3,
      f
...
/**
 * optional string oauth_client_id = 1;
 * @return {string}
 */
proto.api.UIFlags.prototype.getOauthClientId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.api.UIFlags.prototype.setOauthClientId = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string oauth_client_secret = 2;
 * @return {string}
 */
proto.api.UIFlags.prototype.getOauthClientSecret = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.api.UIFlags.prototype.setOauthClientSecret = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional string oauth_authorization_url = 3;
 * @return {string}
 */
proto.api.UIFlags.prototype.getOauthAuthorizationUrl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.api.UIFlags.prototype.setOauthAuthorizationUrl = function(value) {
  jspb.Message.setProto3StringField(this, 3, value);
};


/**
 * optional string oauth_token_url = 4;
 * @return {string}
 */
proto.api.UIFlags.prototype.getOauthTokenUrl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.api.UIFlags.prototype.setOauthTokenUrl = function(value) {
  jspb.Message.setProto3StringField(this, 4, value);
};


/**
 * optional string oauth_redirect_url = 5;
 * @return {string}
 */
proto.api.UIFlags.prototype.getOauthRedirectUrl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};


/** @param {string} value */
proto.api.UIFlags.prototype.setOauthRedirectUrl = function(value) {
  jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @return {!Array<string>}
 */
proto.api.UIFlags.prototype.getOauthScopesList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 6));
};


/** @param {!Array<string>} value */
proto.api.UIFlags.prototype.setOauthScopesList = function(value) {
  jspb.Message.setField(this, 6, value || []);
};
 ...
 * @param {number=} opt_index
 */
proto.api.UIFlags.prototype.addOauthScopes = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 6, value, opt_index);
};


proto.api.UIFlags.prototype.clearOauthScopesList = function() {
  this.setOauthScopesList([]);
};


/**
 * optional string session_secret = 7;
 * @return {string}
 */
proto.api.UIFlags.prototype.getSessionSecret = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 7, ""));
};


/** @param {string} value */
proto.api.UIFlags.prototype.setSessionSecret = function(value) {
  jspb.Message.setProto3StringField(this, 7, value);
};
...
proto.api.Schema.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    constraints: (f = msg.getConstraints()) && proto.api.Constraints.toObject(includeInstance, f),
...
proto.api.Schema.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.api.Constraints;
      reader.readMessage(value,proto.api.Constraints.deserializeBinaryFromReader);
...
proto.api.Schema.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.api.Constraints.serializeBinaryToWriter
    );
  }
 ...
 * @return {?proto.api.Constraints}
 */
proto.api.Schema.prototype.getConstraints = function() {
  return /** @type{?proto.api.Constraints} */ (
    jspb.Message.getWrapperField(this, proto.api.Constraints, 4));
};


/** @param {?proto.api.Constraints|undefined} value */
proto.api.Schema.prototype.setConstraints = function(value) {
  jspb.Message.setWrapperField(this, 4, value);
};


proto.api.Schema.prototype.clearConstraints = function() {
 ...
 * @return {!boolean}
 */
proto.api.Schema.prototype.hasConstraints = function() {
  return jspb.Message.getField(this, 4) != null;
};
...
proto.api.RaftCommand.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    setConstraints: (f = msg.getSetConstraints()) && proto.api.Constraints.toObject(includeInstance, f),
...
/**
 * optional Constraints set_constraints = 9;
 * @return {?proto.api.Constraints}
 */
proto.api.RaftCommand.prototype.getSetConstraints = function() {
  return /** @type{?proto.api.Constraints} */ (
    jspb.Message.getWrapperField(this, proto.api.Constraints, 9));
};


/** @param {?proto.api.Constraints|undefined} value */
proto.api.RaftCommand.prototype.setSetConstraints = function(value) {
  jspb.Message.setWrapperField(this, 9, value);
};


proto.api.RaftCommand.prototype.clearSetConstraints = function() {
  this.setSetConstraints(undefined);
};
 ...
 * @return {!boolean}
 */
proto.api.RaftCommand.prototype.hasSetConstraints = function() {
